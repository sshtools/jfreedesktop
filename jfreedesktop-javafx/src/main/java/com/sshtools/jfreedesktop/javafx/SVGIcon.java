 ...
 */
package com.sshtools.jfreedesktop.javafx;
...
public class SVGIcon extends SwingNode implements Icon {
...
//			throw new RuntimeException(e);
	...
	public void setSvgStream(String uri, InputStream input) throws IOException {
		...
		synchronized (svgUniverse) {
			diagram = svgUniverse.getDiagram(svgUniverse.loadSVG(input, uri));
		}
		if (diagram != null) {
